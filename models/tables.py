...
class User(db.Model):
    ...
    chatbot_documents = relationship("ChatbotDocument", back_populates="creator")
...
class Product(db.Model):
    ...
    CategoryID = db.Column(
        db.Integer, ForeignKey("category.CategoryID"), nullable=False
    )
...
class Cart(db.Model):
    ...
    details = relationship(
        "CartDetail", back_populates="cart", cascade="all, delete-orphan"
    )
...
class ChatMessage(db.Model):
    ...
    UserID = db.Column(
        db.Integer, ForeignKey("user.UserID"), nullable=False, index=True
    )
...
class ChatbotDocument(db.Model):
    ...
    ChatbotDocumentID = db.Column(db.Integer, primary_key=True, autoincrement=True)
    Title = db.Column(db.String, nullable=False)
    Content = db.Column(db.Text, nullable=False)
    SourceType = db.Column(db.String, default="manual")
    SourceName = db.Column(db.String, nullable=True)
    CreatedBy = db.Column(db.Integer, ForeignKey("user.UserID"), nullable=True)
    ...
    creator = relationship("User", back_populates="chatbot_documents")
...
class PcOptionGroup(db.Model):
    ...
    items = relationship(
        "PcOptionItem", back_populates="group", cascade="all, delete-orphan"
    )
...
class PcOptionItem(db.Model):
    ...
    OptionGroupID = db.Column(
        db.Integer, ForeignKey("pc_option_group.OptionGroupID"), nullable=False
    )
    ProductID = db.Column(db.Integer, ForeignKey("product.ProductID"), nullable=False)
...
class ProductTag(db.Model):
    ...
    __table_args__ = (UniqueConstraint("ProductID", "TagID", name="uq_product_tag"),)
